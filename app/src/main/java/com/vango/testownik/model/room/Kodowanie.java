...
@Entity(tableName = "kodowanie_table")
public class Kodowanie extends QuizModel {


    public Kodowanie(Integer id, String question, Answer answerA, Answer answerB, Answer answerC, Answer answerD) {
