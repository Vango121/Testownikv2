...
@Entity(tableName = "pt_table")
public class Pt extends QuizModel {

    public Pt(Integer id, String question, Answer answerA, Answer answerB, Answer answerC, Answer answerD) {
